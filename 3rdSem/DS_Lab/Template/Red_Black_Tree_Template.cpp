...
struct Node
{
    ...
    Node(int key) : data(key), left(NULL), right(NULL), parent(NULL), height(0), size(1), Color(NULL) {}
};
...
void insert_node(int key)
{
    ...
    if (tree_root == NULL)
    {
        tree_root = new_node;
        tree_root->Color = 'B';
        cout << "Tree root Data = " << tree_root->data << " || Tree root Color = " << tree_root->Color << endl;
        return;
    }
    ...
    cout << "Target Data: " << target->data << " || Target Color: " << target->Color << endl;
    ...
    cout << "New Node Data: " << new_node->data << " || New node color: " << new_node->Color << endl;
