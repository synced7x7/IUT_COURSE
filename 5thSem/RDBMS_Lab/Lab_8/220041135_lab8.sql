...
order by category nulls last, subcategory nulls last, region nulls last;

--task2.1
select
    transaction_id,
    to_char(transaction_date, 'DD-Month-YYYY') as formatted_transaction_date
from sales_transactions;
...
SELECT
    ...
    transaction_date
from sales_transactions
where transaction_date < date '2024-03-01' - INTERVAL '1 month';
