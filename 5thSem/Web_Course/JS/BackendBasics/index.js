...
/* Here’s what happens:
app.use('/api/workouts', router) tells Express: */
/* “Mount this router at the /api/workouts path.”
This means every route inside router will be prefixed with /api/workouts. */
